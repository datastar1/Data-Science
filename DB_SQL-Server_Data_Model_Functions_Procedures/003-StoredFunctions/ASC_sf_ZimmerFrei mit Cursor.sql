...
-- =============================================
CREATE OR ALTER FUNCTION [sf_ZimmerFrei] 
(
...
--                         dbo.tb_Zimmer ON dbo.tb_ZimmerBuchung.ZimmerID = dbo.tb_Zimmer.ZimmerID
	...
	SET @ZimmerIDneu = 2 SET @DatumVonneu = '27.01.2023' SET @DatumBisneu = '28.01.2023' --für Test
	...
	BEGIN	--Cursor
		...
		(@ZimmerIDneu = @ZimmerID) AND ((@Datumvonneu <  @DatumBis) AND (@DatumBisneu > @DatumBis))
		) --END IF
