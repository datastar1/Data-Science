CREATE DATABASE [Hotel]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Hotel', FILENAME = N'C:\SQL-Kurs\gruppenarbeit\Hotel.mdf' , SIZE = 16384KB , FILEGROWTH = 10%)
 LOG ON 
( NAME = N'Hotel_log', FILENAME = N'C:\SQL-Kurs\gruppenarbeit\Hotel_log.ldf' , SIZE = 8192KB , FILEGROWTH = 10%)
GO
...
GO
ALTER DATABASE [Hotel] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [Hotel]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [Hotel] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
